...
const midFeatureRows = [
  {
    ...
    imageSrc: 'https://media.istockphoto.com/id/115860829/photo/cross-stitch-alphabet-and-numbers.webp?a=1&b=1&s=612x612&w=0&k=20&c=Qw8qsIZhWwayPG9V8bfQjT2h70GhLgNQn2BqgCOujfU=',
    imageAlt: 'cross-stitch-pattern-alphabet-and-numbers',
    reverse: false,
  },
  {
    ...
    imageSrc: 'Convert-photo-to-crossstitch-charts.png',
    imageAlt: 'Conver-photo-to-cross-stitch-charts',
    reverse: true,
  },
  {
    ...
    imageSrc: 'Cross-Feature1.png',
    imageAlt: 'Learn Cross Stitch Pattern Maker Skills',
    reverse: false,
  },
];
